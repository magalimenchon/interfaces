document.addEventListener("DOMContentLoaded", () => {
    ...
    function redFilter() {
        ...
        for (let x = 0; x < width; x++) {
            for (let y = 0; y < height; y++) {
                //Se coloca solo el rojo de cada pixel correspondiente a la imagen, así como su opacidad.
                r = getRed(imageData, x, y);
                a = getOpacity(imageData, x, y);
                setPixel(imageData, x, y, r, 0, 0, a);
            }
        }
    ...
    //#regionEvents
    //Cuando cambia el selector a Rojo aplica el filtro correspondiente
